...
const DashboardLayout = () => {
    ...
    return (
        <div className={`grid min-h-screen w-full ${collapsed ? 'md:grid-cols-[72px_1fr] lg:grid-cols-[72px_1fr]' : 'md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]'}`}>
            <div className={`hidden border-r bg-muted/40 md:block ${collapsed ? 'w-20' : ''}`}>
                    ...
                    <div className="flex h-14 items-center border-b px-4 lg:h-[60px] lg:px-6">
                        <Link to="/" className="flex items-center gap-2 font-semibold">
                            <img 
                                src={logo} 
                                alt="Royal Ride"
                                className={`${collapsed ? 'h-8 w-8' : 'h-8 w-8 md:h-10 md:w-10 lg:h-12 lg:w-12'}`}
                                />
                        </Link>
            ...
            <div className="flex flex-col overflow-hidden">
                <header className="flex h-14 items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6">
                    ...
                    <DropdownMenu >
                        ...
                        <DropdownMenuContent align="end" className="min-w-[220px] p-2 rounded-xl shadow-lg bg-white border border-gray-100">
                            <div className="flex flex-col items-center gap-2 py-2 border-b border-gray-100 mb-2">
                                ...
                                <span className="text-xs text-gray-500 bg-gray-100 rounded px-2 py-0.5 mt-1">{user?.role?.replace(/_/g, ' ')}</span>
                            </div>
                            <DropdownMenuItem asChild className="flex items-center gap-2 px-3 py-2 rounded hover:bg-blue-50 transition-colors cursor-pointer">
                            ...
                            <DropdownMenuItem className="flex items-center gap-2 px-3 py-2 rounded hover:bg-red-50 transition-colors cursor-pointer" onClick={logout}>
